import { makeStyles, tokens, shorthands, Title1, Text, Switch, Tab, TabList, Button, MessageBar, MessageBarBody, Card, CardHeader } from '@fluentui/react-components';
...
const EditorView: React.FC = () => {
  ...
  const [activeEditorTab, setActiveEditorTab] = useState<'code' | 'file'>('code');
...
int main() {
  ...
  const getLanguageId = () => {
    ...
    return langMap[currentLanguage] || 'cpp';
  };
                ...
                <ReactMarkdown
                  ...
                  components={{
                    code({ node, className, children, ...props }: any) {
                      ...
                      // Check if inline by looking at the node position
                      // Inline code has start.line === end.line
                      ...
                      // Only wrap input/output in Card with copy button
                      ...
                      // Default rendering for other languages - no copy button
                      return (
                        <SyntaxHighlighter
                          style={isDarkMode ? oneDark : oneLight}
                          language={lang}
          ...
          right={
            <div className={styles.editorPane}>
              <div className={styles.editorTabs}>
                <TabList selectedValue={activeEditorTab} onTabSelect={(_, data) => setActiveEditorTab(data.value as 'code' | 'file')}>
